...
exports.CONTINUE_PROMPT = exports.getSystemPrompt = exports.BASE_PROMT = void 0;
const constants_1 = require("../../utils/constants");
const stripindents_1 = require("../../utils/stripindents");
exports.BASE_PROMT = "For all designs I ask you to make, have them be beautiful, not cookie cutter. Make webpages that are fully featured and worthy for production.\n\nBy default, this template supports JSX syntax with Tailwind CSS classes, React hooks, and Lucide React for icons. Do not install other packages for UI themes, icons, etc unless absolutely necessary or I request them.\n\nUse icons from lucide-react for logos.\n\nUse stock photos from unsplash where appropriate, only valid URLs you know exist. Do not download the images, only link to them in image tags.\n\n";
...
<artifact_info>
  ...
  <artifact_instructions>
    ...
    15. ULTRA IMPORTANT:
      - NEVER ever say like this This will be a basic implementation that you can later expand upon
      - NEVER use placeholders like "// rest of the code remains the same..." or "<- leave original code here ->"
      - ALWAYS return all and production level code
      - Make Sure code is always CORRECT
